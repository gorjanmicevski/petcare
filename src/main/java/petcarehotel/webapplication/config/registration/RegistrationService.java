...
import petcarehotel.webapplication.models.exceptions.InvalidEmailException;
...
public class RegistrationService {
  ...
  public String register(RegistrationRequest request) {
    ...
    User user = new User(request.getUsername(), passwordEncoder.encode(request.getPassword()),
        request.getEmail(), request.getFirstName(), request.getLastName(), "00000");
  ...
  /**
   * Building email for the user confirmation.
   *
   * @param name String
   * @param link String
   * @return String
  ...
  private String buildEmail(String name, String link) {
    return
        "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;"
            + "color:#0b0c0c\">\n" + "\n"
            ...
            + "collapse;max-width:580px\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" "
            + "align=\"center\">\n"
            + "          <tbody><tr>\n"
            ...
            + "font-size:19px;line-height:1.315789474;max-width:560px\">\n"
            + "        \n"
            + "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;"
            + "color:#0b0c0c\">Hi " + name
