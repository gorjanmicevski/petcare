...
import petcarehotel.webapplication.config.email.EmailService;
import petcarehotel.webapplication.config.email.EmailValidator;
import petcarehotel.webapplication.config.email.Mail;
...
import petcarehotel.webapplication.models.exceptions.*;
...
public class RegistrationService {
    ...
    @Autowired
    public RegistrationService(UserService userService, ConfirmationTokenService confirmationTokenService, EmailValidator emailValidator, EmailService emailService, UserRepository userRepository, PasswordEncoder passwordEncoder) {
    ...
    public String register(RegistrationRequest request) {
        ...
        User user= new User(request.getUsername(),passwordEncoder.encode(request.getPassword()),request.getEmail(),request.getFirstName(),request.getLastName(),"00000");
...
//            );
        ...
        mail.setMailFrom("noreply_petcare@gmail.com");
