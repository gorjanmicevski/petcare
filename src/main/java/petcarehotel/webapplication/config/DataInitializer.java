...
public class DataInitializer {
  ...
  public void initData() {
    //init users
    User user1 =
        new User("username1", passwordEncoder.encode("pass1"), "email1", "name1", "last1", "num1");
    User user2 =
        new User("username2", passwordEncoder.encode("pass2"), "email2", "name2", "last2", "num2");
    User user3 =
        new User("username3", passwordEncoder.encode("pass3"), "email3", "name3", "last3", "num3");
